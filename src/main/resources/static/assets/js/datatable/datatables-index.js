    ...
    return {
        init: function () {
            ...
            function editRow(oTable, nRow) {
                ...
                jqTds[3].innerHTML = '<select selectedIndex="'+aData[3]+'"><option value="未交">未交</option><option value="已交">已交</option><option value="待退">待退</option><option value="待确认">待确认</option></select>';
              selected = aData[3]
            ...
            function saveRow(oTable, nRow) {
                ...
                oTable.fnUpdate(selected, nRow, 3, false);
            ...
            function cancelEditRow(oTable, nRow) {
                ...
                oTable.fnUpdate($('select').value, nRow, 3, false);
                oTable.fnUpdate('<a href="#" class="btn btn-info btn-xs edit"><i class="fa fa-edit"></i> 编辑</a> <a href="#" class="btn btn-danger btn-xs delete"><i class="fa fa-trash-o"></i> 刪除</a>', nRow, 4, false);
                oTable.fnDraw();
            }
        }
    ...
    return {
        init: function () {
            ...
            function fnFormatDetails(oTable, nTr) {
                ...
                console.log(aData)
                var sOut = '<table>';
                sOut += '<tr><td rowspan="10" style="padding:0 10px 0 0;"><img src="assets/img/avatars/' + aData[6] + '"/></td></tr>';
                sOut += '<tr><td>id:' + aData[1] + '</td></tr>';
                sOut += '<tr><td>主题:' + aData[2] + '</td></tr>';
                sOut += '<tr><td>共享发起者:' + aData[3] + '</td></tr>';
                sOut += '<tr><td>共享接受者:' + aData[4] + '</td></tr>';
                sOut += '<tr><td>共享金额:' + aData[9] + '</td></tr>';
                sOut += '<tr><td>共享时间:' + aData[7] + '</td></tr>';
                sOut += '<tr><td>发起者位置:' + aData[8] + '</td></tr>';
                sOut += '<tr><td>关键字:' + aData[10] + '</td></tr>';
